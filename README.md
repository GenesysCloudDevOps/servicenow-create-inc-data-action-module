A Terraform/CX as Code remote module for the following Custom REST API operation: CreateINC
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/custom-rest-create-inc-data-action-module.git?ref=v1.0.0"
    action_name        = "CreateINC"
